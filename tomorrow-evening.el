;;; tomorrow-evening.el --- A version of Chris Kempson's "tomorrow" themes
...
;;     M-x color-theme--tomorrow-evening
;;
;;; Credit:
...
;;;###autoload
(defun color-theme-tomorrow-evening ()
  "Apply the tomorrow evening theme."
  (interactive)
  (color-theme-sanityinc-tomorrow 'evening))

(color-theme-sanityinc-tomorrow--define-theme evening)

(provide 'tomorrow-evening)
